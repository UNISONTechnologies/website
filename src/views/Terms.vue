...
<template>
    <main-layout header="Terms of Service">
        ...
        <p>
            UNISON Technologies is committed to ensuring that the Services are
            as useful and efficient as possible. For that reason, we reserve the
            right to make changes to the Services or to charge for its services,
            at any time and for any reason. We will never charge you for any of
            the Services without making it very clear to you exactly what you’re
            paying for.
        </p>

        <p>
            The Services use third party services that declare their own Terms
            and Conditions.
        </p>
        ...
        <p>
            ...
            the Services will require the Services to have an active internet
            connection. The connection can be Wi-Fi, or provided by your mobile
            network provider, but UNISON Technologies cannot take responsibility
        ...
        <p>
            If you’re using a Service outside of an area with Wi-Fi, you should
            ...
            connection while accessing the app, or other third party charges. By
            using the Services, you’re accepting responsibility for any such
            charges, including roaming data charges if you use the Services
            ...
            that you have received permission from the bill payer for using the
            Services.
        </p>

        <p>
            Along the same lines, UNISON Technologies cannot always take
            responsibility for the way you use the Services i.e. You need to
            make sure that your device stays charged – if it runs out of battery
            and you can’t turn it on to avail the Service, UNISON Technologies
            cannot accept responsibility.
        </p>

        <p>
            With respect to UNISON Technologies’s responsibility for your use of
            the Services, when you’re using the Services, it’s important to bear
            ...
            information to us so that we can make it available to you. UNISON
            Technologies accepts no liability for any loss, direct or indirect,
